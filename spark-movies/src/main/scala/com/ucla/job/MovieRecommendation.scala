...
object MovieRecommendation {
  ...
  def loadMovieNames() : Map[Int, String] = {
    ...
    val lines = Source.fromFile("/Users/mac/movie_recommendation/cambrian/spark-movies/src/main/resources/input/ml-100k/u.item").getLines()
    for (line <- lines) {
  ...
  def main(args: Array[String]) {
    ...
    // todo
    val data = sc.textFile("/Users/mac/movie_recommendation/cambrian/spark-movies/src/main/resources/input/ml-100k/u.data")
